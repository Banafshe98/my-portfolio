...
function Landing() {
  return (
    <>
      <section className="bg-black mt-10 text-white lg:px-20 md:px-10 py-12 h-full mx-auto my-16 overflow-x-hidden">
        <div className="w-full mx-auto">
          ...
          <div className="flex justify-around gap-3 mb-14 mx-auto mt-5">
            ...
            <div className="flex gap-2 items-center lg:w-[20%]]">
              <Link to="/ContactMe" className="text-sm text-nowrap font-bold cursor-pointer ">GET IN TOUCH</Link>
